...
assign rs232_rx8to8 =  linkUST ? BusA[4] : 1'bz;
assign BusA[3] =  linkUST ? rs232_tx8to8 : 1'bz;
assign BusA[8] =  linkFWM ? BusD[100] : 1'bz;
assign BusA[15] =  linkFWM ? BusD[100] : 1'bz;
assign BusB[53] =  linkESS ? BusA[21] : 1'bz;
assign BusB[51] =  linkESS ? BusA[18] : 1'bz;
assign BusA[19] =  linkESS ? BusB[52] : 1'bz;
assign BusB[54] =  linkESS ? BusA[20] : 1'bz;
assign BusA[16] =  linkESS ? BusC[67] : 1'bz;
assign BusA[2] =  linkEWM ? BusA[16] : 1'bz;
assign BusB[54] =  linkSIO ? sm_cs_n : 1'bz;
assign sm_miso =  linkSIO ? BusB[52] : 1'bz;
assign BusB[51] =  linkSIO ? sm_mosi : 1'bz;
assign BusB[53] =  linkSIO ? sm_sck : 1'bz;
assign BusB[50] =  linkSIO ? spi_receive_status : 1'bz;
assign BusB[50] =  linkSPS ? spi_slave_result_b2b : 1'bz;
assign BusB[51] =  linkSPS ? ss_miso_b2b : 1'bz;
assign ss_mosi_b2b =  linkSPS ? BusB[52] : 1'bz;
assign ss_sck_b2b =  linkSPS ? BusB[53] : 1'bz;
assign ss_ssel_b2b =  linkSPS ? BusB[54] : 1'bz;
assign BusB[53] =  linkFSM ? BusD[98] : 1'bz;
assign BusB[54] =  linkFSM ? BusD[100] : 1'bz;
assign BusB[51] =  linkFSM ? BusA[3] : 1'bz;
assign BusA[4] =  linkFSM ? BusB[52] : 1'bz;
assign BusA[5] =  linkFQD ? pha_out : 1'bz;
assign BusA[14] =  linkFQD ? phb_out : 1'bz;
assign BusD[98] =  linkFSS ? BusB[53] : 1'bz;
assign BusD[100] =  linkFSS ? BusB[54] : 1'bz;
assign BusB[51] =  linkFSS ? BusA[3] : 1'bz;
assign BusA[4] =  linkFSS ? BusB[52] : 1'bz;
assign BusA[21] =  linkESC ? BusB[53] : 1'bz;
assign BusB[51] =  linkESC ? BusA[18] : 1'bz;
assign BusA[19] =  linkESC ? BusB[52] : 1'bz;
assign BusA[20] =  linkESC ? BusB[54] : 1'bz;
assign BusC[67] =  linkESC ? BusA[16] : 1'bz;
assign BusB[50] =  linkPMH ? BusA[16] : 1'bz;
