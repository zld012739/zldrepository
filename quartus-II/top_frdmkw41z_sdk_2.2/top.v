...
assign BusB[69] =  linkTDC ? BusA[15] : 1'bz;
assign BusA[8] =  linkTSI ? BusC[81] : 1'bz;
assign BusA[15] =  linkTSI ? BusC[81] : 1'bz;
assign BusA[8] =  linkMCG ? BusC[81] : 1'bz;
assign BusA[15] =  linkMCG ? BusC[81] : 1'bz;
assign BusA[8] =  linkGLO ? BusC[81] : 1'bz;
assign BusA[15] =  linkGLO ? BusC[81] : 1'bz;
assign BusA[17] =  linkGII ? BusC[81] : 1'bz;
assign BusB[69] =  linkGII ? BusA[16] : 1'bz;
assign BusC[91] =  linkDSP ? BusB[67] : 1'bz;
assign BusC[83] =  linkDSP ? BusB[64] : 1'bz;
assign BusB[73] =  linkDSP ? BusC[85] : 1'bz;
assign BusC[87] =  linkDSP ? BusB[71] : 1'bz;
assign BusB[73] =  linkSPI ? ss_miso_b2b : 1'bz;
assign ss_mosi_b2b =  linkSPI ? BusB[71] : 1'bz;
assign ss_sck_b2b =  linkSPI ? BusB[67] : 1'bz;
assign ss_ssel_b2b =  linkSPI ? BusB[64] : 1'bz;
assign BusA[15] =  linkTPT ? BusC[83] : 1'bz;
assign BusA[8] =  linkTPT ? BusC[83] : 1'bz;
assign BusB[64] =  linkSSI ? sm_cs_n : 1'bz;
assign sm_miso =  linkSSI ? BusB[71] : 1'bz;
assign BusB[73] =  linkSSI ? sm_mosi : 1'bz;
assign BusB[67] =  linkSSI ? sm_sck : 1'bz;
assign BusA[8] =  linkTCP ? BusC[91] : 1'bz;
assign BusA[15] =  linkTCP ? BusC[91] : 1'bz;
assign BusA[15] =  linkTOC ? BusC[83] : 1'bz;
assign BusA[8] =  linkTOC ? BusC[83] : 1'bz;
assign BusA[2] =  linkCMP ? BusA[16] : 1'bz;
assign BusA[17] =  linkCMP ? BusC[81] : 1'bz;
assign BusB[69] =  linkPMH ? BusA[16] : 1'bz;
assign BusA[8] =  linkTSP ? BusC[91] : 1'bz;
assign BusA[15] =  linkTSP ? BusC[91] : 1'bz;
assign BusB[69] =  linkTIC ? BusA[15] : 1'bz;
