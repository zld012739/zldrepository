...
if {$make_assignments} {
	...
	set_global_assignment -name VERILOG_FILE i2c_slave_subad.v
set_global_assignment -name VERILOG_FILE i2c_slave_op_subad.v
set_global_assignment -name VERILOG_FILE I2C_MASTER_SUBAD.v
set_global_assignment -name VERILOG_FILE I2C_wr_subad.v
set_global_assignment -name VERILOG_FILE I2C_MASTER_SUBAD.v
set_global_assignment -name VERILOG_FILE I2C_wr_subad.v
