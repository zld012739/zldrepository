...
assign BusC[83] =  linkSIR ? sm_cs_n : 1'bz;
assign sm_miso =  linkSIR ? BusC[85] : 1'bz;
assign BusC[87] =  linkSIR ? sm_mosi : 1'bz;
assign BusC[91] =  linkSIR ? sm_sck : 1'bz;
assign BusB[50] =  linkSIR ? spi_receive_status : 1'bz;
assign BusC[83] =  linkSIT ? sm_cs_n : 1'bz;
assign sm_miso =  linkSIT ? BusC[87] : 1'bz;
assign BusC[85] =  linkSIT ? sm_mosi : 1'bz;
assign BusC[91] =  linkSIT ? sm_sck : 1'bz;
assign BusB[50] =  linkSIT ? spi_receive_status : 1'bz;
assign BusC[87] =  linkSPS ? ss_miso_b2b : 1'bz;
assign ss_mosi_b2b =  linkSPS ? BusC[85] : 1'bz;
assign ss_sck_b2b =  linkSPS ? BusC[91] : 1'bz;
assign ss_ssel_b2b =  linkSPS ? BusC[83] : 1'bz;
assign BusC[91] =  linkFSM ? BusA[2] : 1'bz;
assign BusC[83] =  linkFSM ? BusA[3] : 1'bz;
assign BusC[87] =  linkFSM ? BusA[4] : 1'bz;
assign BusA[5] =  linkFSM ? BusC[85] : 1'bz;
assign BusC[87] =  linkSPI ? ss_miso_cpha0 : 1'bz;
assign ss_mosi_cpha0 =  linkSPI ? BusC[85] : 1'bz;
assign ss_sck_cpha0 =  linkSPI ? BusC[91] : 1'bz;
assign ss_ssel_cpha0 =  linkSPI ? BusC[83] : 1'bz;
assign BusA[2] =  linkFSS ? BusC[91] : 1'bz;
assign BusA[3] =  linkFSS ? BusC[83] : 1'bz;
assign BusC[87] =  linkFSS ? BusA[4] : 1'bz;
assign BusA[5] =  linkFSS ? BusC[85] : 1'bz;
assign BusC[83] =  linkSIO ? sm_cs_n : 1'bz;
assign sm_miso =  linkSIO ? BusC[85] : 1'bz;
