...
assign BusB[73] =  linkKPP ? BusB[75] : 1'bz;
assign BusA[17] =  linkUSF ? BusB[54] : 1'bz;
assign BusB[51] =  linkPWT ? BusA[15] : 1'bz;
assign BusB[64] =  linkENC ? index_out : 1'bz;
assign BusB[69] =  linkENC ? pha_out : 1'bz;
assign BusB[71] =  linkENC ? phb_out : 1'bz;
assign BusA[14] =  linkEWM ? BusA[16] : 1'bz;
assign BusA[8] =  linkGLO ? BusB[69] : 1'bz;
assign BusA[15] =  linkGLO ? BusB[69] : 1'bz;
assign BusB[53] =  linkSPS ? BusA[21] : 1'bz;
assign BusB[77] =  linkSPS ? BusA[20] : 1'bz;
assign BusB[81] =  linkSPS ? BusA[19] : 1'bz;
assign BusA[18] =  linkSPS ? BusB[50] : 1'bz;
assign BusB[91] =  linkFSM ? BusA[2] : 1'bz;
assign BusB[83] =  linkFSM ? BusA[5] : 1'bz;
assign BusB[87] =  linkFSM ? BusA[3] : 1'bz;
assign BusA[4] =  linkFSM ? BusB[85] : 1'bz;
...
assign BusB[91] =  linkSPI ? BusB[53] : 1'bz;
assign BusB[83] =  linkSPI ? BusB[77] : 1'bz;
assign BusB[87] =  linkSPI ? BusB[50] : 1'bz;
assign BusB[81] =  linkSPI ? BusB[85] : 1'bz;
assign BusA[17] =  linkUST ? compara_error : 1'bz;
assign rs232_rx8to8 =  linkUST ? BusA[2] : 1'bz;
assign BusA[3] =  linkUST ? rs232_tx8to8 : 1'bz;
assign BusA[2] =  linkFSS ? BusB[91] : 1'bz;
assign BusA[5] =  linkFSS ? BusB[83] : 1'bz;
assign BusB[87] =  linkFSS ? BusA[3] : 1'bz;
assign BusA[4] =  linkFSS ? BusB[85] : 1'bz;
assign BusA[15] =  linkFWM ? BusA[2] : 1'bz;
assign BusA[8] =  linkFWM ? BusA[2] : 1'bz;
assign BusA[21] =  linkSPM ? BusB[53] : 1'bz;
assign BusA[20] =  linkSPM ? BusB[77] : 1'bz;
assign BusB[81] =  linkSPM ? BusA[18] : 1'bz;
assign BusA[19] =  linkSPM ? BusB[50] : 1'bz;
assign BusA[15] =  linkPWO ? BusB[98] : 1'bz;
assign BusA[8] =  linkPWO ? BusB[98] : 1'bz;
assign BusA[17] =  linkSHL ? BusB[69] : 1'bz;
assign BusA[2] =  linkGII ? BusA[16] : 1'bz;
assign BusB[98] =  linkCMP ? BusA[16] : 1'bz;
